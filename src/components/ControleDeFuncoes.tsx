...
export function ControleDeFuncoes({ obmContext }: ControleDeFuncoesProps) {
    ...
    return militars
      ...
      .sort((a, b) => {
        ...
        const getWeight = (r: string) =>
          rankWeights[r?.toUpperCase()?.trim()] || 99;
  ...
  const toggleViaturaAll = async (viat: string) => {
    if (displayMilitars.length === 0) return;
    const allChecked = displayMilitars.every(
      (m) => !!m.viaturas?.[viat as keyof typeof m.viaturas],
    );
    const newState = !allChecked;
    ...
    displayMilitars.forEach((m) => {
      if (m.rg) {
        const safeRg = String(m.rg).replace(/^0+/, "").replace(/\D/g, "");
        updateMilitarLocal(safeRg, {
          viaturas: { ...m.viaturas, [viat]: newState },
        });
      }
    });
            ...
            {activeTab === "condutores" && (
              <table className="w-full text-left min-w-[1000px]">
                <thead className="bg-slate-100 border-b border-slate-200">
                  <tr>
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 w-16 text-center">
                      Ativo
                    </th>
                    ...
                    <th
                      colSpan={5}
                      className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center border-l border-slate-200 bg-slate-50"
                    >
                    ...
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center">
                      Abast.
                    </th>
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center border-l border-slate-200">
                      Ala
                    </th>
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center border-l border-slate-200 w-16">
                      Ações
                    </th>
                  </tr>
                  <tr className="bg-slate-50 border-t border-slate-200">
                    ...
                    {VIATURAS.map((v) => (
                      <th
                        key={v}
                        className="px-2 py-1 text-[9px] font-black uppercase tracking-widest text-slate-400 text-center border-l border-slate-200 first:border-l-0"
                      >
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <p className="text-xs mt-1">
                          Pesquise por nome ou RG para adicionar novos
                          condutores.
                        </p>
                      </td>
                    </tr>
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          ...
                          m.ativoCondutor ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoCondutor")
                              }
                        ...
                        {VIATURAS.map((v) => {
                          const hasViat =
                            !!m.viaturas?.[v as keyof typeof m.viaturas];
                          return (
                            <td
                              key={v}
                              className="px-2 py-2 text-center border-l border-slate-100 bg-slate-50/50"
                            >
                              <button
                        ...
                        <td className="px-3 py-2 text-center border-l border-slate-200">
                          <button
                            onClick={() =>
                              toggleFunction(m, "ativoEncarregado")
                            }
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                        ...
                        <td className="px-3 py-2 text-center">
                          <button
                            onClick={() =>
                              toggleFunction(m, "ativoAbastecedor")
                            }
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                  ...
                  {displayMilitars.length === 0 ? (
                    <tr>
                      ...
                      >
                        ...
                        <p className="text-xs mt-1">
                          Pesquise por nome ou RG para adicionar novos chefes.
                        </p>
                      </td>
                    </tr>
                  ) : null}
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoChefeGua ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoChefeGua")
                              }
                              disabled={isProcessing}
                            />
                            <div
              ...
              <table className="w-full text-left min-w-[900px]">
                <thead className="bg-slate-100 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center border-l border-slate-200 bg-slate-50">
                      <ColumnHeaderToggle field="mestreAl" label="Mestre AL" />
                    </th>
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center bg-slate-50">
                      <ColumnHeaderToggle
                        field="mestreBia"
                    ...
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center bg-slate-50">
                      <ColumnHeaderToggle field="opAma" label="OP. AMA" />
                    </th>
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center bg-slate-50">
                      <ColumnHeaderToggle field="gvAma" label="GV. AMA" />
                    </th>
                    <th className="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center bg-slate-50">
                      <ColumnHeaderToggle
                        field="marinheiros"
                  ...
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoMaritimo ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoMaritimo")
                              }
                              disabled={isProcessing}
                            />
                            <div
                        ...
                        <td className="px-3 py-2 text-center border-l border-slate-100 bg-slate-50/50">
                          <button
                            onClick={() => toggleFunction(m, "mestreAl")}
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                              m.mestreAl
                        ...
                        <td className="px-3 py-2 text-center bg-slate-50/50">
                          <button
                            onClick={() => toggleFunction(m, "mestreBia")}
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                              m.mestreBia
                        ...
                        <td className="px-3 py-2 text-center bg-slate-50/50">
                          <button
                            onClick={() => toggleFunction(m, "opAma")}
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                              m.opAma
                        ...
                        <td className="px-3 py-2 text-center bg-slate-50/50">
                          <button
                            onClick={() => toggleFunction(m, "gvAma")}
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                              m.gvAma
                        ...
                        <td className="px-3 py-2 text-center bg-slate-50/50">
                          <button
                            onClick={() => toggleFunction(m, "marinheiros")}
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                              m.marinheiros
                  ...
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoEnfermeiro ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoEnfermeiro")
                              }
                              disabled={isProcessing}
                            />
                            <div
                  ...
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoComunicante ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoComunicante")
                              }
                              disabled={isProcessing}
                            />
                            <div
                  ...
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoGraduado ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoGraduado")
                              }
                              disabled={isProcessing}
                            />
                            <div
                  ...
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoCbsSds ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <td className="px-3 py-2 text-center border-l border-slate-100 bg-slate-50/50">
                          <button
                            onClick={() =>
                              toggleFunction(m, "disponivelCbsSds")
                            }
                            disabled={isProcessing}
                            className={cn(
                              "w-6 h-6 rounded flex items-center justify-center transition-colors mx-auto",
                  ...
                  {displayMilitars.map((m) => {
                    ...
                    return (
                      <tr
                        ...
                        className={cn(
                          "hover:bg-indigo-50/30 transition-colors",
                          m.ativoAuxiliar ? "bg-emerald-50/10" : "",
                        )}
                      >
                        <td className="px-3 py-2 text-center">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() =>
                                toggleFunction(m, "ativoAuxiliar")
                              }
                              disabled={isProcessing}
                            />
                            <div
                        ...
                        <td className="px-3 py-2 border-l border-slate-200">
                          <div className="flex flex-col gap-2">
                            {capabilities.length > 0 ? (
                                  ...
                                  {cap.items.length > 0 && (
                                    <div className="flex flex-wrap gap-1">
                                      {cap.items.map((item) => (
                                        <span
                                          key={item}
                                          className="text-[8px] font-bold text-slate-400 border border-slate-200 rounded px-1 lowercase italic"
                                        >
                                          {item}
                                        </span>
                                      ))}
                              ...
                              <span className="text-[10px] text-slate-300 font-bold uppercase tracking-widest italic text-center block">
                                Nenhuma capacidade atribuída
                              </span>
                            )}
                          </div>
                        </td>
