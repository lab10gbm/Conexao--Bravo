import{c as J,u as ne,r as i,j as e,q as re,U as q,a2 as V,C as L,w as $,z as Y,k as u,x as X,ae as H,P as W,l as j,o as C}from"./index-D7mDlwb_.js";import{T as R}from"./table-DOB1ywSY.js";import{F as le}from"./file-json-DOHyVxL3.js";import{F as ie}from"./file-text-B61Etgdj.js";/**
 * @license lucide-react v0.479.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ce=[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]],de=J("ExternalLink",ce);/**
 * @license lucide-react v0.479.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pe=[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]],xe=J("TrendingUp",pe),me=()=>`
{
    id: 'sync_vacation',
...
`,ge=b=>{const T="ai-studio-applet-webapp-33cfe",p="AIzaSyB46AKE1I7nke459STRmIZ--bURelU3rNY",h="ai-studio-4572982c-0772-4965-98e3-8ccd137a6b92",g=b.endsWith("/")?b.slice(0,-1):b;return new URL(g).hostname,`// ==UserScript==
...
})();`};function ye({user:b,onBack:T}){ne();const[p,h]=i.useState("ferias"),[g,D]=i.useState([]),[Q,K]=i.useState(!0),[E,I]=i.useState("dev"),[Z,F]=i.useState(""),[x,S]=i.useState([]),[G,v]=i.useState(null),[y,A]=i.useState("none"),[d,P]=i.useState(""),[ee,O]=i.useState(""),[l,N]=i.useState(null),[M,w]=i.useState(null),_=window.location.origin,z=E==="pre"?_.replace("ais-dev-","ais-pre-"):_,U=ge(z);i.useEffect(()=>{(async()=>{try{const t=$(Y(u,"personalData"),X("updatedAt","desc"),H(50)),r=(await W(t)).docs.map(n=>({id:n.id,...n.data()}));D(r)}catch(t){console.error("Erro ao carregar personalData:",t)}finally{K(!1)}})()},[]);const te=s=>{try{const t=s.split(`
`).map(n=>n.trim()).filter(n=>n.length>0),a=[];let r=d;if(!r){let n=s.match(/RG[:\s]*([\d.]+)/i);n&&(r=n[1].replace(/\D/g,""))}for(let n=0;n<t.length;n++){const c=t[n];if(c.includes("Ano Ref.")||c.includes("DIRETORIA GERAL")||c.includes("AFASTAMENTOS"))continue;let o=c.split("	");o.length<5&&(o=c.split(/\s{2,}/));const k=/\d{2}\/\d{2}\/\d{4}/,m=o.filter(f=>k.test(f));if(m.length>=2){const f=m[0].includes("2026")?"marcado":"gozado";a.push({id:Math.random().toString(36).substr(2,9),militarRg:r||"00000",ato:o[1]||o[0]||"Concessão",anoRef:o[2]||o[1]||"",anoRetifi:o[3]||"",dataInicio:m[0],dataRetorno:m[1],boletim:o[6]||o[5]||o[4]||"",diasGozados:parseInt(o[7])||parseInt(o[6])||0,diasAGozar:parseInt(o[8])||parseInt(o[7])||0,boletimOrigem:o[9]||o[8]||"",obs:o[10]||o[o.length-1]||"",status:f})}}a.length===0?v("Não foi possível identificar dados. Tente usar a extensão ou copie a tabela de férias novamente."):r?(S(a),v(null)):(v("RG não encontrado no texto. Por favor, insira o RG no campo acima."),S(a))}catch{v("Erro ao processar os dados.")}},ae=async()=>{var s;if(x.length>0&&d)try{for(const t of x){const a=`${d}_${t.anoRef}_${(s=t.dataInicio)==null?void 0:s.replace(/\//g,"")}`,r={...t,militarRg:d,updatedAt:new Date().toISOString()};await j(C(u,"vacations",a),r,{merge:!0}),await j(C(u,"militaries",d,"ferias",a),r,{merge:!0})}alert("Dados de férias importados com sucesso!"),F(""),S([]),P("")}catch(t){console.error(t),alert("Erro ao importar férias.")}else alert("RG ausente ou sem registros para importar.")},se=s=>{try{const t=s.replace(/\s+/g," "),a=(o,k,m)=>{const f=new RegExp(k+":?\\s*(.*?)\\s*(?:"+m+"|$)","i"),B=o.match(f);return B?B[1].trim():""};let r=t.match(/RG:\s*([\d.]+)/i)||t.match(/RG\s*([\d.]+)/i);const n=r?r[1].replace(/\D/g,""):"";if(!n){w("RG não encontrado no texto. Cole a página de dados do militar."),N(null);return}const c={rg:n,pai:a(t,"PAI","MAE:"),mae:a(t,"MAE","Nome de Guerra:"),nomeGuerra:a(t,"Nome de Guerra","Nascimento:"),nascimento:a(t,"Nascimento","CPF:"),cpf:a(t,"CPF","PASEP:"),pasep:a(t,"PASEP","CNH:"),cnh:a(t,"CNH","CAT:"),cnhCat:a(t,"CAT","Grau de Instru"),grauInstrucao:a(t,"Grau de Instrução","E-mail:"),email:a(t,"E-mail","Nacionalidade:"),nacionalidade:a(t,"Nacionalidade","Naturalidade:"),naturalidade:a(t,"Naturalidade","Estado Civil:"),estadoCivil:a(t,"Estado Civil","Sexo:"),sexo:a(t,"Sexo","Tipo Sang"),tipoSanguineo:a(t,"Tipo Sangüíneo","Cor dos Cabelos:"),corCabelos:a(t,"Cor dos Cabelos","Cor dos Olhos:"),corOlhos:a(t,"Cor dos Olhos","Cútis:"),cutis:a(t,"Cútis","Altura:"),altura:a(t,"Altura","Num Calçado:"),numCalcado:a(t,"Num Calçado","Num Quepe:"),numQuepe:a(t,"Num Quepe","Num camisa:"),numCamisa:a(t,"Num camisa","Num Calça:"),numCalca:a(t,"Num Calça","Endereco"),telefoneCelular:a(t,"Telefone Celular","WhatsApp:"),whatsapp:a(t,"WhatsApp","Telefone Funcional:"),telefoneFuncional:a(t,"Telefone Funcional","Telefone Residencial:"),telefoneResidencial:a(t,"Telefone Residencial","OBM Atual:"),obmAtual:a(t,"OBM Atual","Comportamento:"),comportamento:a(t,"Comportamento","Data Boletim"),dataBoletim:a(t,"Data Boletim","Ala:"),ala:a(t,"Ala","Atividade na Ala:"),atividadeAla:a(t,"Atividade na Ala","Função:"),funcao:a(t,"Função","Função Específica:"),funcaoEspecifica:a(t,"Função Específica","Detalhes:"),detalhes:a(t,"Detalhes","Atividade:"),atividade:a(t,"Atividade","RG Anterior:"),identidadeCivil:a(t,"Identidade Civil","Orgao Emissor"),orgaoEmissor:a(t,"Orgao Emissor","Estado Emissor")};c.nomeGuerra||c.cpf?(N(c),w(null)):(w("Não foi possível extrair os dados. Copie todo o texto da página de consulta do militar."),N(null))}catch{w("Erro ao processar os dados pessoais.")}},oe=async()=>{if(l&&l.rg)try{const s={...l,updatedAt:new Date().toISOString()};await j(C(u,"personalData",l.rg),s,{merge:!0}),await j(C(u,"militaries",l.rg),s,{merge:!0}),alert("Dados pessoais importados com sucesso!"),O(""),N(null);const t=$(Y(u,"personalData"),X("updatedAt","desc"),H(50)),a=await W(t);D(a.docs.map(r=>({id:r.id,...r.data()})))}catch(s){console.error(s),alert("Erro ao importar dados pessoais.")}};return e.jsxs("div",{className:"flex flex-col gap-6 p-4 sm:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-7xl mx-auto w-full",children:[e.jsx("div",{className:"mb-4 pt-12",children:e.jsxs("button",{onClick:T,className:"flex items-center gap-2 text-slate-400 hover:text-orange-600 transition-colors uppercase font-black text-[10px] tracking-[0.2em] group mt-6",children:[e.jsx(re,{className:"w-4 h-4 group-hover:-translate-x-1 transition-transform"}),"Voltar"]})}),e.jsxs("div",{className:"flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-16 h-16 bg-orange-600 rounded-2xl flex items-center justify-center text-white shadow-xl",children:e.jsx(xe,{className:"w-8 h-8"})}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-black text-slate-800 uppercase tracking-tight",children:"DGP Sync"}),e.jsx("p",{className:"text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1",children:"Sincronização Universal (Férias e Pessoal)"})]})]}),e.jsxs("button",{onClick:()=>window.open("https://cbmerj.rj.gov.br/dgp/sistema/relatorio_mapa_forca.php","_blank"),className:"px-6 py-4 bg-slate-100 text-slate-600 border-2 border-slate-200 rounded-2xl hover:bg-slate-200 transition-all font-black text-[11px] uppercase tracking-widest flex items-center gap-3 shadow-sm",children:[e.jsx(de,{className:"w-5 h-5"})," Acessar DGP"]})]}),e.jsxs("div",{className:"flex gap-4 mb-2",children:[e.jsxs("button",{onClick:()=>h("ferias"),className:`flex items-center gap-2 px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all ${p==="ferias"?"bg-orange-600 text-white shadow-lg":"bg-slate-100 text-slate-500 hover:bg-slate-200"}`,children:[e.jsx(R,{className:"w-4 h-4"})," Controle de Férias"]}),e.jsxs("button",{onClick:()=>h("pessoal"),className:`flex items-center gap-2 px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all ${p==="pessoal"?"bg-emerald-600 text-white shadow-lg":"bg-slate-100 text-slate-500 hover:bg-slate-200"}`,children:[e.jsx(q,{className:"w-4 h-4"})," Dados Pessoais"]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-8",children:[y!=="none"?e.jsxs("div",{className:"col-span-1 lg:col-span-2 space-y-6",children:[e.jsx("button",{onClick:()=>A("none"),className:"px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold text-xs uppercase transition-colors",children:"← Voltar"}),y==="tampermonkey"?e.jsxs("div",{className:"bg-slate-50 border-2 border-slate-100 rounded-3xl p-8 shadow-inner",children:[e.jsxs("h3",{className:"text-orange-600 font-black text-sm uppercase tracking-widest mb-4 flex items-center gap-2",children:[e.jsx("div",{className:"w-2 h-2 bg-orange-600 rounded-full animate-pulse"}),"Script para Tampermonkey (Recomendado)"]}),e.jsxs("p",{className:"text-slate-600 mb-6 text-sm",children:["O ",e.jsx("strong",{children:"Tampermonkey"})," é o método mais estável para sistemas antigos como o DGP.",e.jsx("br",{}),"1. Instale a extensão ",e.jsx("strong",{children:"Tampermonkey"})," no seu Chrome.",e.jsx("br",{}),'2. Clique no ícone do Tampermonkey e vá em "Criar novo script".',e.jsx("br",{}),"3. Apague tudo o que estiver lá e cole o código abaixo.",e.jsx("br",{}),"4. Salve (Arquivo - Salvar) e pronto! Um botão Universal aparecerá em todas as páginas do DGP."]}),e.jsx("textarea",{readOnly:!0,className:"w-full h-80 bg-white border border-slate-200 rounded-2xl p-6 font-mono text-[10px] shadow-sm mb-4",value:U}),e.jsx("button",{onClick:()=>{navigator.clipboard.writeText(U).then(()=>{alert(`CÓDIGO COPIADO!
Agora cole no Tampermonkey e salve.`)}).catch(s=>{console.error("Failed to copy",s),alert("Erro ao copiar.")})},className:"w-full py-4 bg-orange-600 text-white rounded-xl font-black text-xs uppercase shadow-lg hover:bg-orange-700 transition-colors",children:"COPIAR CÓDIGO DO SCRIPT"})]}):e.jsxs("div",{className:"bg-slate-50 border-2 border-slate-100 rounded-3xl p-8",children:[e.jsx("h3",{className:"text-slate-800 font-black text-sm uppercase tracking-widest mb-4",children:"Arquivos da Extensão DGP (Manual)"}),e.jsxs("p",{className:"text-slate-600 mb-6 text-sm",children:["Crie uma pasta no seu computador chamada ",e.jsx("strong",{children:'"ExtensaoDGP"'}),".",e.jsx("br",{}),"Dentro dessa pasta, crie os arquivos abaixo e cole os respectivos códigos. ",e.jsx("br",{}),"Em seguida, no Chrome, acesse ",e.jsx("strong",{children:"chrome://extensions"}),', ative o "Modo do desenvolvedor" e clique em "Carregar sem compactação".']}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:["manifest","content","popupjs","popuphtml"].map(s=>{const t=s==="manifest"?".json":s==="content"?".js":s==="popupjs"?"popup.js":"popup.html",a=`${z}/api/admin/extension/raw/${s}`;return e.jsxs("div",{className:"bg-white border-2 border-slate-200 rounded-2xl p-6 shadow-sm group",children:[e.jsx("h4",{className:"font-black text-slate-800 uppercase tracking-widest text-xs mb-4",children:s==="manifest"?"manifest.json":s==="content"?"content.js":t}),e.jsxs("a",{href:a,target:"_blank",rel:"noreferrer",className:"block w-full py-3 bg-slate-100 text-slate-800 group-hover:bg-slate-200 rounded-xl text-center font-black text-[10px] uppercase tracking-widest transition-colors",children:["VER CÓDIGO FONTE (",t.toUpperCase(),")"]})]},s)})})]})]}):e.jsxs("div",{className:"space-y-8",children:[e.jsxs("div",{className:"bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden group",children:[e.jsx("div",{className:"absolute top-0 right-0 w-32 h-32 bg-orange-600/10 rounded-full -mr-16 -mt-16 transition-transform group-hover:scale-150 duration-700"}),e.jsxs("h3",{className:"text-orange-400 font-black text-xs uppercase tracking-[0.2em] mb-6 flex items-center gap-3",children:[e.jsx("div",{className:"w-2 h-2 bg-orange-400 rounded-full animate-pulse"}),"Sincronização Automática"]}),e.jsxs("p",{className:"text-[11px] text-slate-300 font-medium leading-relaxed mb-8",children:["Escolha o método que melhor se adapta ao seu computador no quartel. O ",e.jsx("strong",{children:"Tampermonkey"})," é o mais recomendado por ser definitivo e ter o Sincronizador Universal integrado."]}),e.jsxs("div",{className:"bg-zinc-900/50 p-4 rounded-2xl mb-6 border border-zinc-800 shadow-inner",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("p",{className:"text-zinc-400 text-[10px] uppercase font-black tracking-[0.2em]",children:"Conexão do Servidor"}),e.jsx("span",{className:"flex h-2 w-2 rounded-full bg-green-500 animate-pulse"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 bg-black/40 p-1.5 rounded-xl border border-white/5",children:[e.jsx("button",{onClick:()=>I("pre"),className:`py-2.5 text-[10px] font-black rounded-lg transition-all uppercase tracking-wider ${E==="pre"?"bg-orange-600 text-white shadow-[0_0_20px_rgba(234,88,12,0.3)]":"text-zinc-500 hover:text-zinc-300"}`,children:"Produção (PRE)"}),e.jsx("button",{onClick:()=>I("dev"),className:`py-2.5 text-[10px] font-black rounded-lg transition-all uppercase tracking-wider ${E==="dev"?"bg-orange-600 text-white shadow-[0_0_20px_rgba(234,88,12,0.3)]":"text-zinc-500 hover:text-zinc-300"}`,children:"Desenvolvimento"})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("button",{onClick:()=>A("tampermonkey"),className:"block w-full py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl text-center font-black text-[9px] uppercase tracking-[0.3em] transition-all shadow-lg flex items-center justify-center gap-2",children:"🐵 MODO ESTÁVEL (TAMPERMONKEY)"}),e.jsx("button",{onClick:()=>A("extension"),className:"block w-full py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-2xl text-center font-black text-[9px] uppercase tracking-[0.3em] transition-all border border-white/10",children:"📝 MODO EXTENSÃO (CARREGAR MANUAL)"})]})]}),e.jsxs("div",{className:"bg-slate-50 border-2 border-slate-100 rounded-[2.5rem] p-8",children:[e.jsxs("h3",{className:"text-slate-800 font-black text-xs uppercase tracking-widest mb-6 flex items-center gap-2",children:[e.jsx(R,{className:"w-5 h-5 text-emerald-500"}),"Últimos Dados de Pessoal Sincronizados"]}),Q?e.jsx("div",{className:"text-slate-300 font-black uppercase tracking-widest text-[10px] text-center",children:"Carregando dados..."}):g.length===0?e.jsx("div",{className:"flex flex-col items-center justify-center text-center py-4 opacity-40",children:e.jsx("p",{className:"text-slate-400 text-[11px] font-black uppercase tracking-widest",children:"Nenhum dado sincronizado ainda"})}):e.jsx("div",{className:"h-[200px] overflow-auto pr-2 space-y-3",children:g.map((s,t)=>e.jsxs("div",{className:"p-4 bg-white rounded-2xl border border-slate-100 flex flex-col sm:flex-row justify-between gap-4",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"text-[10px] font-black tracking-tighter text-emerald-600 bg-emerald-50 px-2 py-1 rounded",children:s.rg}),e.jsx("div",{children:e.jsx("div",{className:"text-xs font-black text-slate-800 uppercase tracking-tighter",children:s.nomeGuerra||"NOME"})})]}),e.jsx("div",{className:"flex flex-col text-right justify-center",children:e.jsx("div",{className:"text-[10px] font-bold text-slate-600",children:new Date(s.updatedAt).toLocaleDateString("pt-BR")})})]},t))})]})]}),y==="none"&&p==="ferias"&&e.jsx("div",{className:"flex flex-col h-full",children:e.jsxs("div",{className:"bg-white border-2 border-slate-100 rounded-[2.5rem] p-8 shadow-sm h-full flex flex-col",children:[e.jsxs("h3",{className:"text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4 flex items-center gap-3",children:[e.jsx(R,{className:"w-4 h-4"})," Importação Manual de Férias (Backup)"]}),e.jsx("div",{className:"flex flex-col gap-4 mb-4",children:e.jsx("input",{type:"text",placeholder:"Digite o RG do Militar",value:d,onChange:s=>P(s.target.value),className:"w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs font-bold focus:border-orange-500 outline-none"})}),e.jsxs("div",{className:"flex-1 flex flex-col gap-6",children:[e.jsx("textarea",{className:"w-full h-32 bg-slate-50 border-2 border-slate-200 rounded-3xl p-4 font-mono text-[11px] focus:border-orange-500 transition-all outline-none resize-none shadow-inner",placeholder:"Cole os dados de férias (tabela do DGP) aqui...",value:Z,onChange:s=>{F(s.target.value),te(s.target.value)}}),e.jsx("div",{className:"flex-1 min-h-[150px] border-2 border-dashed border-slate-200 rounded-3xl p-4 overflow-y-auto",children:G?e.jsxs("div",{className:"h-full flex flex-col items-center justify-center text-center",children:[e.jsx(V,{className:"w-8 h-8 text-slate-300 mb-2"}),e.jsx("p",{className:"text-slate-400 text-[10px] font-black uppercase leading-relaxed",children:G})]}):x.length>0?e.jsx("div",{className:"space-y-2",children:x.map((s,t)=>e.jsxs("div",{className:"bg-white p-3 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"text-[9px] font-black text-orange-600 bg-orange-50 px-2 py-1 rounded",children:["R:",s.anoRef]}),e.jsx("div",{children:e.jsxs("div",{className:"text-[10px] font-black text-slate-800 uppercase tracking-tighter",children:[s.dataInicio," - ",s.dataRetorno]})})]}),e.jsxs("div",{className:"text-right font-black text-slate-400 text-[9px] uppercase",children:[s.diasGozados,"D"]})]},t))}):e.jsxs("div",{className:"h-full flex flex-col items-center justify-center text-center opacity-20",children:[e.jsx(le,{className:"w-10 h-10 text-slate-300 mb-2"}),e.jsx("p",{className:"text-slate-400 text-[10px] font-black uppercase tracking-widest",children:"Aguardando dados..."})]})}),e.jsxs("button",{onClick:ae,disabled:x.length===0||!d,className:"w-full py-4 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-black disabled:opacity-50 transition-all flex items-center justify-center gap-3 shadow-xl",children:[e.jsx(L,{className:"w-4 h-4"})," Importar ",x.length," Registros"]})]})]})}),y==="none"&&p==="pessoal"&&e.jsx("div",{className:"flex flex-col h-full",children:e.jsxs("div",{className:"bg-white border-2 border-slate-100 rounded-[2.5rem] p-8 shadow-sm h-full flex flex-col",children:[e.jsxs("h3",{className:"text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em] mb-4 flex items-center gap-3",children:[e.jsx(q,{className:"w-4 h-4"})," Importação Manual de Dados Pessoais (Backup)"]}),e.jsxs("div",{className:"flex-1 flex flex-col gap-6 mt-4",children:[e.jsx("textarea",{className:"w-full h-40 bg-slate-50 border-2 border-slate-200 rounded-3xl p-4 font-mono text-[11px] focus:border-emerald-500 transition-all outline-none resize-none shadow-inner",placeholder:"Cole todo o texto da página de dados pessoais do DGP (Ctrl+A e Ctrl+C na página da intranet)...",value:ee,onChange:s=>{O(s.target.value),se(s.target.value)}}),e.jsx("div",{className:"flex-1 min-h-[150px] border-2 border-dashed border-slate-200 rounded-3xl p-4 overflow-y-auto",children:M?e.jsxs("div",{className:"h-full flex flex-col items-center justify-center text-center",children:[e.jsx(V,{className:"w-8 h-8 text-slate-300 mb-2"}),e.jsx("p",{className:"text-slate-400 text-[10px] font-black uppercase leading-relaxed",children:M})]}):l?e.jsxs("div",{className:"bg-white p-4 rounded-xl border border-emerald-100 shadow-sm flex flex-col gap-3",children:[e.jsxs("div",{className:"flex items-center gap-3 border-b border-slate-50 pb-3",children:[e.jsxs("div",{className:"text-[10px] font-black text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-lg",children:["RG: ",l.rg]}),e.jsx("div",{className:"text-[11px] font-black text-slate-800 uppercase tracking-tight",children:l.nomeGuerra||l.cpf})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-[9px] uppercase tracking-wider text-slate-500",children:[e.jsxs("div",{children:[e.jsx("span",{className:"font-bold text-slate-400",children:"NASCIMENTO:"})," ",l.nascimento||"---"]}),e.jsxs("div",{children:[e.jsx("span",{className:"font-bold text-slate-400",children:"CPF:"})," ",l.cpf||"---"]}),e.jsxs("div",{children:[e.jsx("span",{className:"font-bold text-slate-400",children:"TELEFONE:"})," ",l.telefoneCelular||"---"]}),e.jsxs("div",{children:[e.jsx("span",{className:"font-bold text-slate-400",children:"TIPO SANG:"})," ",l.tipoSanguineo||"---"]})]})]}):e.jsxs("div",{className:"h-full flex flex-col items-center justify-center text-center opacity-20",children:[e.jsx(ie,{className:"w-10 h-10 text-emerald-600 mb-2"}),e.jsx("p",{className:"text-slate-400 text-[10px] font-black uppercase tracking-widest",children:"Aguardando colagem..."})]})}),e.jsxs("button",{onClick:oe,disabled:!l,className:"w-full py-4 bg-emerald-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-emerald-700 disabled:opacity-50 transition-all flex items-center justify-center gap-3 shadow-xl",children:[e.jsx(L,{className:"w-4 h-4"})," Importar Dados de Pessoal"]})]})]})})]})]})}export{ye as DgpSyncModule};
